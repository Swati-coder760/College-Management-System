...
<div class="container-fluid">
    ...
    <div class="form-group">
        ...
        <label for="username">username:</label><br>
            <input type="text" id="username" class="form-control"  name="admin_name"required><br><br>
            ...
            <input type="text" id="usertype"class="form-control" name="usertype" value="admin" readonly></br> </br>
