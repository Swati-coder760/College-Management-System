...
?> 
    ...
    <h2>Extra Curricular Activities Informations</h2></div>
    <div class="content">
    <div class="widget">
    <?php
    // Include database connection
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td>";
            echo "<a href='edit_extracurricula_activities.php?id=". $row["id"]. "'>Edit</a> ";
            echo "<a href='delete_extracurricula_activities.php?id=". $row["id"]. "' onclick='return confirm(\"Are you sure you want to delete this user?\")'>Delete</a>";
            echo "</td>";
            echo "</tr>";
        }
        echo "</table>";
